...
class Video implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'url' => 'string',
        'timeSt' => 'string',
        'videoType' => '\App\OpenAPI\Model\VideoType'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('timeSt', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($timeSt)) {
            throw new \InvalidArgumentException('non-nullable timeSt cannot be null');
        }
     ...
     * Sets videoType
     *
     * @param \App\OpenAPI\Model\VideoType $videoType videoType
     *
     * @return self
     */
