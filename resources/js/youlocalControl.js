        ...
        $(function($) {
            $('.slider').on('input', function() {
                let val = $(this).val();
                let time_interval= (getYouTubeVideo().getDuration() - $("#video1_time_st").val()) / 100;
                if(getYouTubeVideo().getDuration() > getLocalVideo().duration) time_interval= (getLocalVideo().duration - $("#video2_time_st").val()) / 100;
                document.getElementById("pause").click();
                document.getElementById("pauseLocal2").click();
                getYouTubeVideo().seekTo(Number($("#video1_time_st").val()) + (time_interval * val));
                getLocalVideo().currentTime = Number($("#video2_time_st").val()) + (time_interval * val); 
            });
