...
$(function($) {
    $('.slider').on('input', function() {
        let val = $(this).val();
        let time_interval= (getPlayerIndex(0).duration - $("#video1_time_st").val()) / 100;
        if(getPlayerIndex(0).duration > getPlayerIndex(1).duration) time_interval= (getPlayerIndex(1).duration - $("#video2_time_st").val()) / 100;
        document.getElementById("pauseLocal1").click();
        document.getElementById("pauseLocal2").click();
        getPlayerIndex(0).currentTime = Number($("#video1_time_st").val()) + (time_interval * val);
        getPlayerIndex(1).currentTime = Number($("#video2_time_st").val()) + (time_interval * val);
