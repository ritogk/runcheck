...
import SaveModalT from "./file-controller-parts/save-modal-t.vue"
import OpenModalT from "./file-controller-parts/open-modal-t.vue"
...
<template>
  <div>
    <SaveModalT></SaveModalT>
    <OpenModalT></OpenModalT>
